...
/* SQL to insert information in the database */
INSERT INTO torganizers (name, contact, logo) VALUES
('Gobierno Municipal de Chihuahua', 'eventos@chihuahua.gob.mx', 'gobierno_chihuahua.jpg'),
('Universidad Autónoma de Chihuahua', 'eventos@uach.mx', 'uach.jpeg'),
('Teatro de la Ciudad', 'contacto@teatrodelaciudad.mx', 'teatro_ciudad.jpg'),
('Casa Chihuahua', 'eventos@casachihuahua.org', 'casa_chihuahua.jpg'),
('Centro de Convenciones Expo Chihuahua', 'info@expochihuahua.com', 'expo_chihuahua.jpeg'),
('Conservatorio de Música de Chihuahua', 'eventos@conservatoriochihuahua.edu.mx', 'conservatorio.jpeg'),
('Plaza Mayor', 'eventos@plazamayor.mx', 'plaza_mayor.jpg'),
('Parque El Palomar', 'parques@chihuahua.gob.mx', 'parque_palomar.jpg'),
('Deportes Chihuahua', 'contacto@deporteschihuahua.mx', 'deportes_chihuahua.png'),
('Fundación Cultural Chihuahua', 'contacto@fundacionculturalchihuahua.org', 'fundacion_cultural.jpg'),
('Biblioteca Central Carlos Montemayor', 'info@bibliotecamontemayor.mx', 'biblioteca_montemayor.jpg'),
('Festival Internacional Chihuahua', 'contacto@fichihuahua.mx', 'fichihuahua.jpeg'),
('Centro Cultural Quinta Gameros', 'eventos@quintagameros.mx', 'quinta_gameros.jpg'),
('Museo Semilla', 'info@museosemilla.mx', 'museo_semilla.png'),
('Foro Cultural Independiente', 'contacto@forocultural.mx', 'foro_cultural.png'),
('Centro de Desarrollo Cultural', 'eventos@cdcchihuahua.mx', 'centro_desarrollo.jpg'),
('Museo de la Revolución Mexicana', 'info@museorevolucion.mx', 'museo_revolucion.jpg'),
('Universidad Tecnológica de Chihuahua', 'eventos@utch.mx', 'utch.png'),
('Asociación de Escritores de Chihuahua', 'contacto@escritoreschihuahua.mx', 'escritores.jpeg'),
('Orquesta Filarmónica del Estado', 'info@filarmonicachihuahua.mx', 'filarmonica.jpeg'),
('Centro de Espectáculos Chihuahua', 'eventos@espectaculoschihuahua.mx', 'centro_espectaculos.jpeg'),
('Centro Deportivo Norte', 'contacto@centronorte.mx', 'deportivo_norte.jpg'),
('Centro Histórico de Chihuahua', 'info@centrohistorico.mx', 'centro_historico.jpg'),
('Parque Metropolitano Tres Presas', 'parques@chihuahua.gob.mx', 'parque_tres_presas.jpg'),
('Centro de Innovación y Emprendimiento', 'info@ciechihuahua.mx', 'centro_innovacion.jpeg');
